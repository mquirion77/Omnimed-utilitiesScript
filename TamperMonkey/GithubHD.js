...
(function() {
    ...
    var resize = function() {
      ...
      $('.discussion-timeline.pull-discussion-timeline.js-pull-discussion-timeline.js-quote-selection-container.js-review-state-classes.is-review-pending').width('80%');
      $('.container').width('98%');
